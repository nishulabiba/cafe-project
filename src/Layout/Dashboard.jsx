...
import { faBars, faBarsProgress, faBook, faCalendar, faCalendarCheck, faHome, faHomeUser, faShoppingCart, faSignOut, faStar, faUsers, faUtensils, faWallet } from "@fortawesome/free-solid-svg-icons";
          ...
          {/* Sidebar content here */}
          {
            isAdmin ?
              <>
                ...
                <li><NavLink className="" to="/dashboard/reservation"> <FontAwesomeIcon icon={faCalendar} />Reservation</NavLink></li>
                <li><NavLink className="" to="/dashboard/mybookings"> <FontAwesomeIcon icon={faCalendarCheck} />My Bookings</NavLink></li>
                <li><NavLink className="" to="/dashboard/addreview"> <FontAwesomeIcon icon={faStar} />Add Review</NavLink></li>
              </>
          }
